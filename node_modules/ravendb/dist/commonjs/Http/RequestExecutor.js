...
class RequestExecutor {
    ...
    */
    ...
    static async createAgent(options) {
        try {
            const { Agent: AgentInstance } = await import((0, ImportUtil_js_1.importFix)("undici"));
    ...
    static _readExceptionFromServer(req, response, body, e) {
        ...
        const exceptionSchema = {
            ...
            message: e.message,
            error: `An exception occurred while contacting ${req.uri}: ${e.message} . ${OsUtil_js_1.EOL + e.stack}`,
            type: e.name
        };
