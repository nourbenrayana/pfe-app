...
class AbstractJavaScriptIndexCreationTask extends BaseJavaScriptIndexCreationTask_js_1.BaseJavaScriptIndexCreationTask {
    _map;
    _reduce;
    constructor() {
        super();
    ...
    map(collectionOrDocumentType, definition) {
        if (this._map) {
            (0, index_js_1.throwError)("InvalidOperationException", "Map function was already defined. " +
    ...
    addSource(nameOrFunction, source) {
        ...
        if (!TypeUtil_js_1.TypeUtil.isString(nameOrFunction)) {
...
//# sourceMappingURL=AbstractJavaScriptIndexCreationTask.js.map