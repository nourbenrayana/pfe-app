...
const CountersIndexDefinitionBuilder_js_1 = require("../Counters/CountersIndexDefinitionBuilder.js");
...
class AbstractMultiMapTimeSeriesIndexCreationTask extends AbstractGenericTimeSeriesIndexCreationTask_js_1.AbstractGenericTimeSeriesIndexCreationTask {
    maps = [];
    _addMap(map) {
        if (!map) {
