...
export class AbstractJavaScriptIndexCreationTask extends BaseJavaScriptIndexCreationTask {
    _map;
    _reduce;
    constructor() {
        super();
    ...
    map(collectionOrDocumentType, definition) {
        if (this._map) {
            throwError("InvalidOperationException", "Map function was already defined. " +
